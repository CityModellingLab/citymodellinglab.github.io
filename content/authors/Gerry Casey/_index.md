...
interests:
  - Large-scale agent-based and activity-based modelling of urban mobility and behaviour 
  - Evidence-based transport appraisal and decision support for sustainable urban policy 
  - Responsible, real-world applications of AI 
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:gerry.casey@ucl.ac.uk'
  - icon: link
    icon_pack: fas
    link: https://profiles.ucl.ac.uk/98951-gerry-casey
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/gerard-casey-4655a219/
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.co.uk/citations?user=CMqz0-YAAAAJ&hl=en
  - icon: github
    icon_pack: fab
